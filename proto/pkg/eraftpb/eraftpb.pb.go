...
type ConfChangeContext struct {
	...
	Confver              uint64   `protobuf:"varint,2,opt,name=confver,proto3" json:"confver,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ConfChangeContext) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfChangeContext.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfChangeContext) GetStoreId() uint64 {
	if m != nil {
		return m.StoreId
	}
	return 0
...
func (m *ConfChangeContext) GetConfver() uint64 {
	if m != nil {
		return m.Confver
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ConfChangeContext)(nil), "eraftpb.ConfChangeContext")
}
...
var fileDescriptor_acd9f78e51523dd8 = []byte{
	...
	,
}
...
func (m *ConfChangeContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Confver != 0 {
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Confver))
		i--
		dAtA[i] = 0x10
	}
	if m.StoreId != 0 {
...
func (m *ConfChangeContext) Size() (n int) {
	...
	if m.Confver != 0 {
		n += 1 + sovEraftpb(uint64(m.Confver))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
